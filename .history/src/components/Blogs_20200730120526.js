      ...
      <div style={{marginTop: '100', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column'}}>
        ...
        <div className='ui card' style={{ width: '75%', padding: '20px' }}>
          ...
          <div className='content'>
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis fugit obcaecati ut vel iste repellendus, officia molestiae minus exercitationem nesciunt necessitatibus doloremque dolorem inventore vero maxime nemo quaerat consequatur laborum?</div>
          </div>
        </div>
