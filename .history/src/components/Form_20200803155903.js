  ...
  render(){
    return(
      <div style={{ margin: '40px' }}>
        ...
        <div className="ui fluid input">
          <textarea type="text" name="article" id='article'  cols='30' rows='10' <div className='description' style={{whiteSpace: 'pre-wrap'}}>{article}</div> onChange={this.handleChange} value={this.state.blog.article} ></textarea>
        </div>
        </div>
      </div>
      <div className="field">
