  ...
  render() {
    return (
      ...
      <div style={{width: '50%'}}>
        ...
        <hr style={{width: '50%', color: 'black', margin: '50px auto 20px auto'}}/>
        <CreateBlog handleBlogSubmit={this.handleBlogSubmit} />
      </div>
      <div style={{width: '50%'}}>
        <Blogs searchTerm={this.state.searchTerm} blogs={this.state.blogs} onDelete={this.onDelete} onUpdate={this.onUpdtea} />
      </div>
